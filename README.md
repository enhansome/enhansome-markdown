Awesome Markdown Series - For Editors & (Pre)viewers, see [Awesome Markdown Editors & (Pre)viewers »](https://github.com/mundimark/awesome-markdown-editors) ⭐ 2,253 | 🐛 64 | 📅 2026-08-06
...
* [Markdown Tutorial](http://markdowntutorial.com) - [:octocat:](https://github.com/gjtorikian/markdowntutorial.com) ⭐ 605 | 🐛 9 | 🌐 HTML | 📅 2026-06-29
...
github: [github.com/jgm/pandoc](https://github.com/jgm/pandoc) ⭐ 46,155 | 🐛 1,032 | 🌐 Haskell | 📅 2026-09-06) -
...
**marked**
(web: [`marked.js.org`](https://marked.js.org), github: [marked :octocat:](https://github.com/markedjs/marked) ⭐ 37,123 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-05) a markdown parser and compiler. Built for speed. (In Javascript)

<a name="markdown-it"></a>

**markdown-it**
(web: [`markdown-it.github.io`](https://markdown-it.github.io/), github: [markdown-it :octocat:](https://github.com/markdown-it/markdown-it) ⭐ 21,879 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-27) Javascript markdown parser. 100% CommonMark support, extensions, syntax plugins & high speed.
...
**mq**
(web: [mqlang.org](https://mqlang.org), github: [mq :octocat:](https://github.com/harehare/mq) ⭐ 1,027 | 🐛 15 | 🌐 Rust | 📅 2026-09-06) A command-line tool that processes Markdown using a syntax similar to jq. Written in Rust, allowing you to easily slice, filter, map, and transform structured data in Markdown files.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,322 | 🐛 83 | 🌐 JavaScript | 📅 2026-09-06 - A Node.js style checker and lint tool for Markdown/CommonMark files offering a good set of defaults. Allows for customization.
...
* [mado](https://github.com/akiomik/mado) ⭐ 403 | 🐛 18 | 🌐 Rust | 📅 2026-09-06 - A fast Markdown linter written in Rust. GitHub Actions are supported.
...
github: [`jekyll/jekyll` :octocat:](https://github.com/jekyll/jekyll) ⭐ 51,661 | 🐛 256 | 🌐 Ruby | 📅 2026-08-03,
...
**Slidev** (github: [`slidev`](http://github.com/slidevjs/slidev) ⭐ 48,430 | 🐛 230 | 🌐 TypeScript | 📅 2026-08-25) - Slidev allows you to create slideshows from a markdown file. You can include HTML and Vue components in the markdown.
...
* [word-to-markdowm gem :octocat:](https://github.com/benbalter/word-to-markdown) ⭐ 1,550 | 🐛 12 | 🌐 Ruby | 📅 2026-09-06, [:gem:](https://rubygems.org/gems/word-to-markdown) - "liberate" content from the jail that is Microsoft Word documents; converts to plain-text Markdown
...
* [linkedin2md :octocat:](https://github.com/juanmanueldaza/linkedin2md) ⭐ 43 | 🐛 0 | 🌐 Python | 📅 2026-08-12, [:snake:](https://pypi.org/project/linkedin2md/) - zero-dependency Python CLI to convert LinkedIn data export ZIPs into clean, structured Markdown files optimized for LLM analysis; optional PDF resume generation via `--pdf`
...
* [turndown :octocat:](https://github.com/domchristie/turndown) ⭐ 11,426 | 🐛 144 | 🌐 HTML | 📅 2026-09-03, [(npm Package)](https://www.npmjs.com/package/turndown), [(Demo site)](http://domchristie.github.io/turndown/)  - a HTML to Markdown converter in JavaScript (formerly known as `to-markdown`)
...
* [demarkus](https://github.com/latebit-io/demarkus) ⭐ 15 | 🐛 4 | 🌐 Go | 📅 2026-09-06 - De-centralized markup for us: a markdown protocol, server, browser, and tools
