...
github: [github.com/jgm/pandoc](https://github.com/jgm/pandoc) ⭐ 46,053 | 🐛 1,033 | 🌐 Haskell | 📅 2026-08-29) -
...
**marked**
(web: [`marked.js.org`](https://marked.js.org), github: [marked :octocat:](https://github.com/markedjs/marked) ⭐ 37,098 | 🐛 22 | 🌐 JavaScript | 📅 2026-08-24) a markdown parser and compiler. Built for speed. (In Javascript)
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,309 | 🐛 82 | 🌐 JavaScript | 📅 2026-08-28 - A Node.js style checker and lint tool for Markdown/CommonMark files offering a good set of defaults. Allows for customization.
...
**Slidev** (github: [`slidev`](http://github.com/slidevjs/slidev) ⭐ 48,321 | 🐛 223 | 🌐 TypeScript | 📅 2026-08-25) - Slidev allows you to create slideshows from a markdown file. You can include HTML and Vue components in the markdown.
...
* [turndown :octocat:](https://github.com/domchristie/turndown) ⭐ 11,408 | 🐛 150 | 🌐 HTML | 📅 2026-06-23, [(npm Package)](https://www.npmjs.com/package/turndown), [(Demo site)](http://domchristie.github.io/turndown/)  - a HTML to Markdown converter in JavaScript (formerly known as `to-markdown`)
...
* [demarkus](https://github.com/latebit-io/demarkus) ⭐ 15 | 🐛 6 | 🌐 Go | 📅 2026-08-29 - De-centralized markup for us: a markdown protocol, server, browser, and tools
