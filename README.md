Awesome Markdown Series - For Editors & (Pre)viewers, see [Awesome Markdown Editors & (Pre)viewers »](https://github.com/mundimark/awesome-markdown-editors) ⭐ 2,253 | 🐛 63 | 📅 2026-08-06
...
* [The Ultimate Markdown Cheat Sheet](https://github.com/lifeparticle/Markdown-Cheatsheet) ⭐ 833 | 🐛 5 | 🌐 Mermaid | 📅 2025-07-12
...
github: [github.com/jgm/pandoc](https://github.com/jgm/pandoc) ⭐ 46,145 | 🐛 1,033 | 🌐 Haskell | 📅 2026-09-05) -
...
**marked**
(web: [`marked.js.org`](https://marked.js.org), github: [marked :octocat:](https://github.com/markedjs/marked) ⭐ 37,119 | 🐛 20 | 🌐 JavaScript | 📅 2026-09-05) a markdown parser and compiler. Built for speed. (In Javascript)

<a name="markdown-it"></a>

**markdown-it**
(web: [`markdown-it.github.io`](https://markdown-it.github.io/), github: [markdown-it :octocat:](https://github.com/markdown-it/markdown-it) ⭐ 21,876 | 🐛 8 | 🌐 TypeScript | 📅 2026-08-27) Javascript markdown parser. 100% CommonMark support, extensions, syntax plugins & high speed.
...
**mq**
(web: [mqlang.org](https://mqlang.org), github: [mq :octocat:](https://github.com/harehare/mq) ⭐ 1,026 | 🐛 15 | 🌐 Rust | 📅 2026-09-05) A command-line tool that processes Markdown using a syntax similar to jq. Written in Rust, allowing you to easily slice, filter, map, and transform structured data in Markdown files.
...
* [mado](https://github.com/akiomik/mado) ⭐ 390 | 🐛 17 | 🌐 Rust | 📅 2026-09-05 - A fast Markdown linter written in Rust. GitHub Actions are supported.
...
github: [`jekyll/jekyll` :octocat:](https://github.com/jekyll/jekyll) ⭐ 51,660 | 🐛 256 | 🌐 Ruby | 📅 2026-08-03,
...
**Slidev** (github: [`slidev`](http://github.com/slidevjs/slidev) ⭐ 48,421 | 🐛 228 | 🌐 TypeScript | 📅 2026-08-25) - Slidev allows you to create slideshows from a markdown file. You can include HTML and Vue components in the markdown.
...
* [word-to-markdowm gem :octocat:](https://github.com/benbalter/word-to-markdown) ⭐ 1,550 | 🐛 15 | 🌐 Ruby | 📅 2026-09-05, [:gem:](https://rubygems.org/gems/word-to-markdown) - "liberate" content from the jail that is Microsoft Word documents; converts to plain-text Markdown
...
* [reverse\_markdown :octocat:](https://github.com/xijo/reverse_markdown) ⭐ 681 | 🐛 16 | 🌐 Ruby | 📅 2026-01-20, [:gem:](https://rubygems.org/gems/reverse_markdown) - map simple HTML back into markdown
...
* [turndown :octocat:](https://github.com/domchristie/turndown) ⭐ 11,422 | 🐛 144 | 🌐 HTML | 📅 2026-09-03, [(npm Package)](https://www.npmjs.com/package/turndown), [(Demo site)](http://domchristie.github.io/turndown/)  - a HTML to Markdown converter in JavaScript (formerly known as `to-markdown`)
...
* [GitBook.com](https://www.gitbook.com)  - write and publish books with Markdown and Git by Samy Pessé et al
  * [GitBook :octocat:](https://github.com/GitbookIO/gitbook) ⭐ 29,023 | 🐛 100 | 🌐 TypeScript | 📅 2026-09-04 - a command line tool (and Node.js library) for building beautiful books using GitHub/Git and Markdown (or AsciiDoc)
...
* [Bitbooks.cc (discontinued; archived)](https://github.com/bitbooks) - Bitbooks turns a repo full of markdown files into a handsome, hosted, online book - by Bryan Braun
  * [Franklin :octocat:](https://github.com/bryanbraun/franklin) ⭐ 144 | 🐛 2 | 🌐 CSS | 📅 2017-01-13 - a static-site framework, optimized for online books

## Protocol

* [demarkus](https://github.com/latebit-io/demarkus) ⭐ 15 | 🐛 3 | 🌐 Go | 📅 2026-09-05 - De-centralized markup for us: a markdown protocol, server, browser, and tools
