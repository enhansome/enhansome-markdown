Awesome Markdown Series - For Editors & (Pre)viewers, see [Awesome Markdown Editors & (Pre)viewers »](https://github.com/mundimark/awesome-markdown-editors) ⭐ 2,265 | 🐛 70 | 📅 2026-08-06
...
* [Emojis](http://www.emoji-cheat-sheet.com) - [:octocat:](https://github.com/arvida/emoji-cheat-sheet.com) ⭐ 6,318 | 🐛 58 | 🌐 HTML | 📅 2022-05-28
...
* Manuscripts Book Starter Kit (github: [`manuscripts/book-starter`](https://github.com/manuscripts/book-starter) ⭐ 19 | 🐛 0 | 📅 2016-07-04)
...
* Code (github: [`jgm/CommonMark`](https://github.com/jgm/CommonMark) ⭐ 5,145 | 🐛 130 | 🌐 Python | 📅 2026-04-27) - spec and reference code in JavaScript and C
...
* Code (github: [`github/cmark`](https://github.com/github/cmark) ⭐ 1,130 | 🐛 135 | 🌐 C | 📅 2026-07-13 - reference code in C (fork of cmark w/ extensions)
...
* [Markdown Cheatsheet :octocat:](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet) ⭐ 60,255 | 🐛 319 | 🌐 JavaScript | 📅 2025-08-22
* [The Ultimate Markdown Cheat Sheet](https://github.com/lifeparticle/Markdown-Cheatsheet) ⭐ 836 | 🐛 5 | 🌐 Mermaid | 📅 2025-07-12
...
* [Markdown Tutorial](http://markdowntutorial.com) - [:octocat:](https://github.com/gjtorikian/markdowntutorial.com) ⭐ 606 | 🐛 9 | 🌐 HTML | 📅 2026-06-29
...
github: [github.com/jgm/pandoc](https://github.com/jgm/pandoc) ⭐ 46,347 | 🐛 1,039 | 🌐 Haskell | 📅 2026-09-20) -
a universal document converter (in Haskell)

**kramdown**
(web: [`kramdown.gettalong.org`](http://kramdown.gettalong.org),
github: [`gettalong/kramdown`](https://github.com/gettalong/kramdown) ⭐ 1,782 | 🐛 19 | 🌐 Ruby | 📅 2026-01-31,
...
**marked**
(web: [`marked.js.org`](https://marked.js.org), github: [marked :octocat:](https://github.com/markedjs/marked) ⭐ 37,170 | 🐛 24 | 🌐 JavaScript | 📅 2026-09-15) a markdown parser and compiler. Built for speed. (In Javascript)

<a name="markdown-it"></a>

**markdown-it**
(web: [`markdown-it.github.io`](https://markdown-it.github.io/), github: [markdown-it :octocat:](https://github.com/markdown-it/markdown-it) ⭐ 21,930 | 🐛 8 | 🌐 TypeScript | 📅 2026-09-12) Javascript markdown parser. 100% CommonMark support, extensions, syntax plugins & high speed.
...
:octocat:](https://github.com/deftio/quikdown) ⭐ 16 | 🐛 2 | 🌐 JavaScript | 📅 2026-08-01) Lightweight (10KB) markdown parser with bidirectional
...
**mq**
(web: [mqlang.org](https://mqlang.org), github: [mq :octocat:](https://github.com/harehare/mq) ⭐ 1,034 | 🐛 15 | 🌐 Rust | 📅 2026-09-20) A command-line tool that processes Markdown using a syntax similar to jq. Written in Rust, allowing you to easily slice, filter, map, and transform structured data in Markdown files.

**markdown-to-jsx**
(web: [markdown-to-jsx.quantizor.dev](https://markdown-to-jsx.quantizor.dev), github: [markdown-to-jsx :octocat:](https://github.com/quantizor/markdown-to-jsx) ⭐ 2,388 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-15, [npm](https://www.npmjs.com/package/markdown-to-jsx)) A very fast and versatile markdown toolchain. Output to AST, React, React Native, SolidJS, Vue, HTML, and more!
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,350 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-19 - A Node.js style checker and lint tool for Markdown/CommonMark files offering a good set of defaults. Allows for customization.
* [vscode-markdownlint](https://github.com/DavidAnson/vscode-markdownlint) ⭐ 1,291 | 🐛 12 | 🌐 JavaScript | 📅 2026-09-12 - [Visual Studio Code Plugin](https://marketplace.visualstudio.com/items?itemName=DavidAnson.vscode-markdownlint) enabling in-place linting of markdown files.
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 823 | 🐛 67 | 🌐 Python | 📅 2026-08-31 - CommonMark compliant Markdown formatter
* [mado](https://github.com/akiomik/mado) ⭐ 409 | 🐛 40 | 🌐 Rust | 📅 2026-09-15 - A fast Markdown linter written in Rust. GitHub Actions are supported.
...
* [darnlink](https://github.com/txemi/darnlink) ⭐ 18 | 🐛 3 | 🌐 Python | 📅 2026-09-17 - Python CLI that repairs Markdown links whose target moved (anchored by a UUID) and robustifies plain ones; report-only pre-commit/CI gate. GitHub Action & pre-commit hook included.
...
github: [`jekyll/jekyll` :octocat:](https://github.com/jekyll/jekyll) ⭐ 51,675 | 🐛 251 | 🌐 Ruby | 📅 2026-09-17,
...
github: [`adam-p/markdown-here`](https://github.com/adam-p/markdown-here) ⭐ 60,255 | 🐛 319 | 🌐 JavaScript | 📅 2025-08-22) -
...
**Slidev** (github: [`slidev`](http://github.com/slidevjs/slidev) ⭐ 48,753 | 🐛 203 | 🌐 TypeScript | 📅 2026-09-16) - Slidev allows you to create slideshows from a markdown file. You can include HTML and Vue components in the markdown.
...
**markdeep-slides** (github: [markdeep-slides](https://github.com/doersino/markdeep-slides) ⭐ 187 | 🐛 6 | 🌐 JavaScript | 📅 2025-02-19) - Browser-side rendering of Markdown as slide deck
...
* **Generate a markdown table of contents (TOC) with [remarkable](https://github.com/jonschlinkert/remarkable) ⭐ 5,843 | 🐛 133 | 🌐 JavaScript | 📅 2024-05-17**
  (github: [`markdown-toc`](https://github.com/jonschlinkert/markdown-toc) ⭐ 1,753 | 🐛 90 | 🌐 JavaScript | 📅 2024-08-09)
...
* [word-to-markdowm gem :octocat:](https://github.com/benbalter/word-to-markdown) ⭐ 1,551 | 🐛 11 | 🌐 Ruby | 📅 2026-09-16, [:gem:](https://rubygems.org/gems/word-to-markdown) - "liberate" content from the jail that is Microsoft Word documents; converts to plain-text Markdown
...
* [Jimmy :octocat:](https://github.com/marph91/jimmy) ⭐ 530 | 🐛 14 | 🌐 Python | 📅 2026-09-13 - Convert your notes to Markdown

### LinkedIn / Career Data to Markdown

* [linkedin2md :octocat:](https://github.com/juanmanueldaza/linkedin2md) ⭐ 45 | 🐛 0 | 🌐 Python | 📅 2026-08-12, [:snake:](https://pypi.org/project/linkedin2md/) - zero-dependency Python CLI to convert LinkedIn data export ZIPs into clean, structured Markdown files optimized for LLM analysis; optional PDF resume generation via `--pdf`

### Hypertext Markup Language (HTML) to Markdown

Ruby

* [reverse\_markdown :octocat:](https://github.com/xijo/reverse_markdown) ⭐ 681 | 🐛 14 | 🌐 Ruby | 📅 2026-09-10, [:gem:](https://rubygems.org/gems/reverse_markdown) - map simple HTML back into markdown
...
* [turndown :octocat:](https://github.com/domchristie/turndown) ⭐ 11,440 | 🐛 144 | 🌐 HTML | 📅 2026-09-03, [(npm Package)](https://www.npmjs.com/package/turndown), [(Demo site)](http://domchristie.github.io/turndown/)  - a HTML to Markdown converter in JavaScript (formerly known as `to-markdown`)
...
* [widdershins :octocat:](https://github.com/Mermade/widdershins) ⭐ 1,582 | 🐛 89 | 🌐 JavaScript | 📅 2024-06-04 - turn [OpenAPI/Swagger](https://www.openapis.org) REST API documentation to Markdown
* [Moxygen :octocat:](https://github.com/sourcey/moxygen) ⭐ 277 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-03 - [Doxygen](http://www.stack.nl/~dimitri/doxygen/) (C++, but also supports other popular programming languages such as C, Objective-C, C#, PHP, Java, Python, IDL , Fortran, VHDL, Tcl, and to some extent D.) documentation to Markdown
* [mmarkdown :octocat:](https://github.com/albinotonnina/mmarkdown) ⭐ 79 | 🐛 1 | 🌐 JavaScript | 📅 2021-03-30 - Interpret mmd fenced code blocks in a markdown file and generate a cooler version of it.
...
* [GitBook.com](https://www.gitbook.com)  - write and publish books with Markdown and Git by Samy Pessé et al
  * [GitBook :octocat:](https://github.com/GitbookIO/gitbook) ⭐ 29,032 | 🐛 102 | 🌐 TypeScript | 📅 2026-09-18 - a command line tool (and Node.js library) for building beautiful books using GitHub/Git and Markdown (or AsciiDoc)
...
* [demarkus](https://github.com/latebit-io/demarkus) ⭐ 15 | 🐛 3 | 🌐 Go | 📅 2026-09-20 - De-centralized markup for us: a markdown protocol, server, browser, and tools
