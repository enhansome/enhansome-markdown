Awesome Markdown Series - For Editors & (Pre)viewers, see [Awesome Markdown Editors & (Pre)viewers »](https://github.com/mundimark/awesome-markdown-editors) ⭐ 2,255 | 🐛 65 | 📅 2026-08-06
...
github: [github.com/jgm/pandoc](https://github.com/jgm/pandoc) ⭐ 46,218 | 🐛 1,035 | 🌐 Haskell | 📅 2026-09-10) -
...
**marked**
(web: [`marked.js.org`](https://marked.js.org), github: [marked :octocat:](https://github.com/markedjs/marked) ⭐ 37,132 | 🐛 16 | 🌐 JavaScript | 📅 2026-09-10) a markdown parser and compiler. Built for speed. (In Javascript)

<a name="markdown-it"></a>

**markdown-it**
(web: [`markdown-it.github.io`](https://markdown-it.github.io/), github: [markdown-it :octocat:](https://github.com/markdown-it/markdown-it) ⭐ 21,890 | 🐛 10 | 🌐 TypeScript | 📅 2026-08-27) Javascript markdown parser. 100% CommonMark support, extensions, syntax plugins & high speed.
...
**mq**
(web: [mqlang.org](https://mqlang.org), github: [mq :octocat:](https://github.com/harehare/mq) ⭐ 1,028 | 🐛 15 | 🌐 Rust | 📅 2026-09-10) A command-line tool that processes Markdown using a syntax similar to jq. Written in Rust, allowing you to easily slice, filter, map, and transform structured data in Markdown files.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,335 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-10 - A Node.js style checker and lint tool for Markdown/CommonMark files offering a good set of defaults. Allows for customization.
* [vscode-markdownlint](https://github.com/DavidAnson/vscode-markdownlint) ⭐ 1,282 | 🐛 11 | 🌐 JavaScript | 📅 2026-09-04 - [Visual Studio Code Plugin](https://marketplace.visualstudio.com/items?itemName=DavidAnson.vscode-markdownlint) enabling in-place linting of markdown files.
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 819 | 🐛 65 | 🌐 Python | 📅 2026-08-31 - CommonMark compliant Markdown formatter
* [mado](https://github.com/akiomik/mado) ⭐ 405 | 🐛 34 | 🌐 Rust | 📅 2026-09-10 - A fast Markdown linter written in Rust. GitHub Actions are supported.
...
github: [`jekyll/jekyll` :octocat:](https://github.com/jekyll/jekyll) ⭐ 51,654 | 🐛 258 | 🌐 Ruby | 📅 2026-08-03,
...
**Slidev** (github: [`slidev`](http://github.com/slidevjs/slidev) ⭐ 48,607 | 🐛 232 | 🌐 TypeScript | 📅 2026-08-25) - Slidev allows you to create slideshows from a markdown file. You can include HTML and Vue components in the markdown.
...
* [Jimmy :octocat:](https://github.com/marph91/jimmy) ⭐ 530 | 🐛 14 | 🌐 Python | 📅 2026-08-29 - Convert your notes to Markdown
...
* [turndown :octocat:](https://github.com/domchristie/turndown) ⭐ 11,429 | 🐛 144 | 🌐 HTML | 📅 2026-09-03, [(npm Package)](https://www.npmjs.com/package/turndown), [(Demo site)](http://domchristie.github.io/turndown/)  - a HTML to Markdown converter in JavaScript (formerly known as `to-markdown`)
...
* [GitBook.com](https://www.gitbook.com)  - write and publish books with Markdown and Git by Samy Pessé et al
  * [GitBook :octocat:](https://github.com/GitbookIO/gitbook) ⭐ 29,025 | 🐛 107 | 🌐 TypeScript | 📅 2026-09-10 - a command line tool (and Node.js library) for building beautiful books using GitHub/Git and Markdown (or AsciiDoc)
