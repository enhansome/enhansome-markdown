...
* Code (github: [`jgm/CommonMark`](https://github.com/jgm/CommonMark) ⭐ 5,142 | 🐛 131 | 🌐 Python | 📅 2026-04-27) - spec and reference code in JavaScript and C
...
github: [github.com/jgm/pandoc](https://github.com/jgm/pandoc) ⭐ 46,189 | 🐛 1,030 | 🌐 Haskell | 📅 2026-09-08) -
...
**marked**
(web: [`marked.js.org`](https://marked.js.org), github: [marked :octocat:](https://github.com/markedjs/marked) ⭐ 37,133 | 🐛 22 | 🌐 JavaScript | 📅 2026-09-07) a markdown parser and compiler. Built for speed. (In Javascript)
...
**mq**
(web: [mqlang.org](https://mqlang.org), github: [mq :octocat:](https://github.com/harehare/mq) ⭐ 1,028 | 🐛 15 | 🌐 Rust | 📅 2026-09-08) A command-line tool that processes Markdown using a syntax similar to jq. Written in Rust, allowing you to easily slice, filter, map, and transform structured data in Markdown files.

**markdown-to-jsx**
(web: [markdown-to-jsx.quantizor.dev](https://markdown-to-jsx.quantizor.dev), github: [markdown-to-jsx :octocat:](https://github.com/quantizor/markdown-to-jsx) ⭐ 2,386 | 🐛 15 | 🌐 TypeScript | 📅 2026-08-14, [npm](https://www.npmjs.com/package/markdown-to-jsx)) A very fast and versatile markdown toolchain. Output to AST, React, React Native, SolidJS, Vue, HTML, and more!
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,326 | 🐛 84 | 🌐 JavaScript | 📅 2026-09-08 - A Node.js style checker and lint tool for Markdown/CommonMark files offering a good set of defaults. Allows for customization.
...
* [mado](https://github.com/akiomik/mado) ⭐ 405 | 🐛 30 | 🌐 Rust | 📅 2026-09-08 - A fast Markdown linter written in Rust. GitHub Actions are supported.
...
**Slidev** (github: [`slidev`](http://github.com/slidevjs/slidev) ⭐ 48,462 | 🐛 231 | 🌐 TypeScript | 📅 2026-08-25) - Slidev allows you to create slideshows from a markdown file. You can include HTML and Vue components in the markdown.
...
* [turndown :octocat:](https://github.com/domchristie/turndown) ⭐ 11,424 | 🐛 144 | 🌐 HTML | 📅 2026-09-03, [(npm Package)](https://www.npmjs.com/package/turndown), [(Demo site)](http://domchristie.github.io/turndown/)  - a HTML to Markdown converter in JavaScript (formerly known as `to-markdown`)
...
* [GitBook.com](https://www.gitbook.com)  - write and publish books with Markdown and Git by Samy Pessé et al
  * [GitBook :octocat:](https://github.com/GitbookIO/gitbook) ⭐ 29,024 | 🐛 102 | 🌐 TypeScript | 📅 2026-09-08 - a command line tool (and Node.js library) for building beautiful books using GitHub/Git and Markdown (or AsciiDoc)
...
* [demarkus](https://github.com/latebit-io/demarkus) ⭐ 15 | 🐛 3 | 🌐 Go | 📅 2026-09-08 - De-centralized markup for us: a markdown protocol, server, browser, and tools
