...
* [Markdown Cheatsheet :octocat:](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet) ⭐ 60,261 | 🐛 319 | 🌐 JavaScript | 📅 2025-08-22
...
github: [github.com/jgm/pandoc](https://github.com/jgm/pandoc) ⭐ 46,415 | 🐛 1,055 | 🌐 Haskell | 📅 2026-09-25) -
...
**marked**
(web: [`marked.js.org`](https://marked.js.org), github: [marked :octocat:](https://github.com/markedjs/marked) ⭐ 37,212 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-22) a markdown parser and compiler. Built for speed. (In Javascript)
...
**mq**
(web: [mqlang.org](https://mqlang.org), github: [mq :octocat:](https://github.com/harehare/mq) ⭐ 1,036 | 🐛 11 | 🌐 Rust | 📅 2026-09-26) A command-line tool that processes Markdown using a syntax similar to jq. Written in Rust, allowing you to easily slice, filter, map, and transform structured data in Markdown files.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,356 | 🐛 82 | 🌐 JavaScript | 📅 2026-09-26 - A Node.js style checker and lint tool for Markdown/CommonMark files offering a good set of defaults. Allows for customization.
...
github: [`jekyll/jekyll` :octocat:](https://github.com/jekyll/jekyll) ⭐ 51,692 | 🐛 251 | 🌐 Ruby | 📅 2026-09-17,
...
github: [`adam-p/markdown-here`](https://github.com/adam-p/markdown-here) ⭐ 60,261 | 🐛 319 | 🌐 JavaScript | 📅 2025-08-22) -
...
**Slidev** (github: [`slidev`](http://github.com/slidevjs/slidev) ⭐ 48,847 | 🐛 208 | 🌐 TypeScript | 📅 2026-09-16) - Slidev allows you to create slideshows from a markdown file. You can include HTML and Vue components in the markdown.
...
* [Moxygen :octocat:](https://github.com/sourcey/moxygen) ⭐ 278 | 🐛 15 | 🌐 TypeScript | 📅 2026-09-03 - [Doxygen](http://www.stack.nl/~dimitri/doxygen/) (C++, but also supports other popular programming languages such as C, Objective-C, C#, PHP, Java, Python, IDL , Fortran, VHDL, Tcl, and to some extent D.) documentation to Markdown
...
* [json2md](https://github.com/IonicaBizau/json2md) ⭐ 655 | 🐛 8 | 🌐 JavaScript | 📅 2025-04-11 - A JSON to Markdown converter.
...
* [GitBook.com](https://www.gitbook.com)  - write and publish books with Markdown and Git by Samy Pessé et al
  * [GitBook :octocat:](https://github.com/GitbookIO/gitbook) ⭐ 29,043 | 🐛 104 | 🌐 TypeScript | 📅 2026-09-25 - a command line tool (and Node.js library) for building beautiful books using GitHub/Git and Markdown (or AsciiDoc)
...
* [demarkus](https://github.com/latebit-io/demarkus) ⭐ 15 | 🐛 3 | 🌐 Go | 📅 2026-09-26 - De-centralized markup for us: a markdown protocol, server, browser, and tools
