Awesome Markdown Series - For Editors & (Pre)viewers, see [Awesome Markdown Editors & (Pre)viewers »](https://github.com/mundimark/awesome-markdown-editors) ⭐ 2,254 | 🐛 61 | 📅 2026-08-06
...
* [Emojis](http://www.emoji-cheat-sheet.com) - [:octocat:](https://github.com/arvida/emoji-cheat-sheet.com) ⭐ 6,323 | 🐛 56 | 🌐 HTML | 📅 2022-05-28
...
* Code (github: [`github/cmark`](https://github.com/github/cmark) ⭐ 1,127 | 🐛 135 | 🌐 C | 📅 2026-07-13 - reference code in C (fork of cmark w/ extensions)
...
github: [github.com/jgm/pandoc](https://github.com/jgm/pandoc) ⭐ 46,123 | 🐛 1,034 | 🌐 Haskell | 📅 2026-09-03) -
...
**marked**
(web: [`marked.js.org`](https://marked.js.org), github: [marked :octocat:](https://github.com/markedjs/marked) ⭐ 37,113 | 🐛 28 | 🌐 JavaScript | 📅 2026-09-03) a markdown parser and compiler. Built for speed. (In Javascript)
...
**mq**
(web: [mqlang.org](https://mqlang.org), github: [mq :octocat:](https://github.com/harehare/mq) ⭐ 1,025 | 🐛 16 | 🌐 Rust | 📅 2026-09-03) A command-line tool that processes Markdown using a syntax similar to jq. Written in Rust, allowing you to easily slice, filter, map, and transform structured data in Markdown files.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,319 | 🐛 83 | 🌐 JavaScript | 📅 2026-09-02 - A Node.js style checker and lint tool for Markdown/CommonMark files offering a good set of defaults. Allows for customization.
* [vscode-markdownlint](https://github.com/DavidAnson/vscode-markdownlint) ⭐ 1,279 | 🐛 10 | 🌐 JavaScript | 📅 2026-09-03 - [Visual Studio Code Plugin](https://marketplace.visualstudio.com/items?itemName=DavidAnson.vscode-markdownlint) enabling in-place linting of markdown files.
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 817 | 🐛 66 | 🌐 Python | 📅 2026-08-31 - CommonMark compliant Markdown formatter
* [mado](https://github.com/akiomik/mado) ⭐ 384 | 🐛 10 | 🌐 Rust | 📅 2026-09-03 - A fast Markdown linter written in Rust. GitHub Actions are supported.
...
**Slidev** (github: [`slidev`](http://github.com/slidevjs/slidev) ⭐ 48,406 | 🐛 226 | 🌐 TypeScript | 📅 2026-08-25) - Slidev allows you to create slideshows from a markdown file. You can include HTML and Vue components in the markdown.
...
* [linkedin2md :octocat:](https://github.com/juanmanueldaza/linkedin2md) ⭐ 41 | 🐛 0 | 🌐 Python | 📅 2026-08-12, [:snake:](https://pypi.org/project/linkedin2md/) - zero-dependency Python CLI to convert LinkedIn data export ZIPs into clean, structured Markdown files optimized for LLM analysis; optional PDF resume generation via `--pdf`
...
* [turndown :octocat:](https://github.com/domchristie/turndown) ⭐ 11,418 | 🐛 144 | 🌐 HTML | 📅 2026-09-03, [(npm Package)](https://www.npmjs.com/package/turndown), [(Demo site)](http://domchristie.github.io/turndown/)  - a HTML to Markdown converter in JavaScript (formerly known as `to-markdown`)
...
* [Moxygen :octocat:](https://github.com/sourcey/moxygen) ⭐ 275 | 🐛 12 | 🌐 TypeScript | 📅 2026-09-02 - [Doxygen](http://www.stack.nl/~dimitri/doxygen/) (C++, but also supports other popular programming languages such as C, Objective-C, C#, PHP, Java, Python, IDL , Fortran, VHDL, Tcl, and to some extent D.) documentation to Markdown
...
* [GitBook.com](https://www.gitbook.com)  - write and publish books with Markdown and Git by Samy Pessé et al
  * [GitBook :octocat:](https://github.com/GitbookIO/gitbook) ⭐ 29,019 | 🐛 98 | 🌐 TypeScript | 📅 2026-09-03 - a command line tool (and Node.js library) for building beautiful books using GitHub/Git and Markdown (or AsciiDoc)
...
* [demarkus](https://github.com/latebit-io/demarkus) ⭐ 15 | 🐛 2 | 🌐 Go | 📅 2026-09-03 - De-centralized markup for us: a markdown protocol, server, browser, and tools
