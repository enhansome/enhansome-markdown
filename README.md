Awesome Markdown Series - For Editors & (Pre)viewers, see [Awesome Markdown Editors & (Pre)viewers »](https://github.com/mundimark/awesome-markdown-editors) ⭐ 2,247 | 🐛 56 | 📅 2026-08-06
...
* Code (github: [`jgm/CommonMark`](https://github.com/jgm/CommonMark) ⭐ 5,136 | 🐛 128 | 🌐 Python | 📅 2026-04-27) - spec and reference code in JavaScript and C
...
* Code (github: [`github/cmark`](https://github.com/github/cmark) ⭐ 1,124 | 🐛 135 | 🌐 C | 📅 2026-07-13 - reference code in C (fork of cmark w/ extensions)
...
* [The Ultimate Markdown Cheat Sheet](https://github.com/lifeparticle/Markdown-Cheatsheet) ⭐ 828 | 🐛 5 | 🌐 Mermaid | 📅 2025-07-12
...
* [Markdown Tutorial](http://markdowntutorial.com) - [:octocat:](https://github.com/gjtorikian/markdowntutorial.com) ⭐ 604 | 🐛 9 | 🌐 HTML | 📅 2026-06-29
...
github: [github.com/jgm/pandoc](https://github.com/jgm/pandoc) ⭐ 46,037 | 🐛 1,034 | 🌐 Haskell | 📅 2026-08-27) -
...
**marked**
(web: [`marked.js.org`](https://marked.js.org), github: [marked :octocat:](https://github.com/markedjs/marked) ⭐ 37,095 | 🐛 20 | 🌐 JavaScript | 📅 2026-08-24) a markdown parser and compiler. Built for speed. (In Javascript)

<a name="markdown-it"></a>

**markdown-it**
(web: [`markdown-it.github.io`](https://markdown-it.github.io/), github: [markdown-it :octocat:](https://github.com/markdown-it/markdown-it) ⭐ 21,852 | 🐛 7 | 🌐 TypeScript | 📅 2026-08-26) Javascript markdown parser. 100% CommonMark support, extensions, syntax plugins & high speed.
...
**mq**
(web: [mqlang.org](https://mqlang.org), github: [mq :octocat:](https://github.com/harehare/mq) ⭐ 1,022 | 🐛 14 | 🌐 Rust | 📅 2026-08-27) A command-line tool that processes Markdown using a syntax similar to jq. Written in Rust, allowing you to easily slice, filter, map, and transform structured data in Markdown files.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,304 | 🐛 82 | 🌐 JavaScript | 📅 2026-08-26 - A Node.js style checker and lint tool for Markdown/CommonMark files offering a good set of defaults. Allows for customization.
* [vscode-markdownlint](https://github.com/DavidAnson/vscode-markdownlint) ⭐ 1,278 | 🐛 10 | 🌐 JavaScript | 📅 2026-08-26 - [Visual Studio Code Plugin](https://marketplace.visualstudio.com/items?itemName=DavidAnson.vscode-markdownlint) enabling in-place linting of markdown files.
* [mdformat](https://github.com/executablebooks/mdformat) ⭐ 812 | 🐛 62 | 🌐 Python | 📅 2026-08-17 - CommonMark compliant Markdown formatter
* [mado](https://github.com/akiomik/mado) ⭐ 381 | 🐛 8 | 🌐 Rust | 📅 2026-08-24 - A fast Markdown linter written in Rust. GitHub Actions are supported.
...
* [darnlink](https://github.com/txemi/darnlink) ⭐ 18 | 🐛 4 | 🌐 Python | 📅 2026-08-27 - Python CLI that repairs Markdown links whose target moved (anchored by a UUID) and robustifies plain ones; report-only pre-commit/CI gate. GitHub Action & pre-commit hook included.
...
**Slidev** (github: [`slidev`](http://github.com/slidevjs/slidev) ⭐ 48,298 | 🐛 221 | 🌐 TypeScript | 📅 2026-08-25) - Slidev allows you to create slideshows from a markdown file. You can include HTML and Vue components in the markdown.
...
**GitPitch** (website: [GitPitch](http://gitpitch.com/), github: [gitpitch :octocat:](https://github.com/gitpitch/gitpitch/) ⭐ 5,475 | 🐛 13 | 🌐 Python | 📅 2021-03-01) – Markdown Presentations For Everyone on GitHub, GitLab, Bitbucket, GitBucket, Gitea, and Gogs. [Example](https://gitpitch.com/gitpitch/gitpitch/master)
...
* [turndown :octocat:](https://github.com/domchristie/turndown) ⭐ 11,406 | 🐛 150 | 🌐 HTML | 📅 2026-06-23, [(npm Package)](https://www.npmjs.com/package/turndown), [(Demo site)](http://domchristie.github.io/turndown/)  - a HTML to Markdown converter in JavaScript (formerly known as `to-markdown`)
...
* [Moxygen :octocat:](https://github.com/sourcey/moxygen) ⭐ 275 | 🐛 14 | 🌐 TypeScript | 📅 2026-08-27 - [Doxygen](http://www.stack.nl/~dimitri/doxygen/) (C++, but also supports other popular programming languages such as C, Objective-C, C#, PHP, Java, Python, IDL , Fortran, VHDL, Tcl, and to some extent D.) documentation to Markdown
...
* [GitBook.com](https://www.gitbook.com)  - write and publish books with Markdown and Git by Samy Pessé et al
  * [GitBook :octocat:](https://github.com/GitbookIO/gitbook) ⭐ 29,012 | 🐛 99 | 🌐 TypeScript | 📅 2026-08-27 - a command line tool (and Node.js library) for building beautiful books using GitHub/Git and Markdown (or AsciiDoc)
...
* [demarkus](https://github.com/latebit-io/demarkus) ⭐ 15 | 🐛 6 | 🌐 Go | 📅 2026-08-27 - De-centralized markup for us: a markdown protocol, server, browser, and tools
