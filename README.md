Awesome Markdown Series - For Editors & (Pre)viewers, see [Awesome Markdown Editors & (Pre)viewers »](https://github.com/mundimark/awesome-markdown-editors) ⭐ 2,224 | 🐛 49 | 📅 2026-08-06
...
* [Emojis](http://www.emoji-cheat-sheet.com) - [:octocat:](https://github.com/arvida/emoji-cheat-sheet.com) ⭐ 6,322 | 🐛 56 | 🌐 HTML | 📅 2022-05-28
...
* Code (github: [`jgm/CommonMark`](https://github.com/jgm/CommonMark) ⭐ 5,133 | 🐛 128 | 🌐 Python | 📅 2026-04-27) - spec and reference code in JavaScript and C
...
* Code (github: [`github/cmark`](https://github.com/github/cmark) ⭐ 1,117 | 🐛 135 | 🌐 C | 📅 2026-07-13 - reference code in C (fork of cmark w/ extensions)
...
* [Markdown Cheatsheet :octocat:](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet) ⭐ 60,251 | 🐛 318 | 🌐 JavaScript | 📅 2025-08-22
...
github: [github.com/jgm/pandoc](https://github.com/jgm/pandoc) ⭐ 45,881 | 🐛 1,051 | 🌐 Haskell | 📅 2026-08-14) -
a universal document converter (in Haskell)

**kramdown**
(web: [`kramdown.gettalong.org`](http://kramdown.gettalong.org),
github: [`gettalong/kramdown`](https://github.com/gettalong/kramdown) ⭐ 1,780 | 🐛 18 | 🌐 Ruby | 📅 2026-01-31,
...
**marked**
(web: [`marked.js.org`](https://marked.js.org), github: [marked :octocat:](https://github.com/markedjs/marked) ⭐ 37,054 | 🐛 14 | 🌐 JavaScript | 📅 2026-08-15) a markdown parser and compiler. Built for speed. (In Javascript)

<a name="markdown-it"></a>

**markdown-it**
(web: [`markdown-it.github.io`](https://markdown-it.github.io/), github: [markdown-it :octocat:](https://github.com/markdown-it/markdown-it) ⭐ 21,816 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-13) Javascript markdown parser. 100% CommonMark support, extensions, syntax plugins & high speed.
...
**mq**
(web: [mqlang.org](https://mqlang.org), github: [mq :octocat:](https://github.com/harehare/mq) ⭐ 1,007 | 🐛 13 | 🌐 Rust | 📅 2026-08-16) A command-line tool that processes Markdown using a syntax similar to jq. Written in Rust, allowing you to easily slice, filter, map, and transform structured data in Markdown files.
...
* [markdownlint](https://github.com/DavidAnson/markdownlint) ⭐ 6,278 | 🐛 81 | 🌐 JavaScript | 📅 2026-08-14 - A Node.js style checker and lint tool for Markdown/CommonMark files offering a good set of defaults. Allows for customization.
* [vscode-markdownlint](https://github.com/DavidAnson/vscode-markdownlint) ⭐ 1,275 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-16 - [Visual Studio Code Plugin](https://marketplace.visualstudio.com/items?itemName=DavidAnson.vscode-markdownlint) enabling in-place linting of markdown files.
...
* [mdsf](https://github.com/hougesen/mdsf) ⭐ 109 | 🐛 33 | 🌐 Rust | 📅 2026-08-14 - Use your preferred code formatter to format markdown code snippets.
* [darnlink](https://github.com/txemi/darnlink) ⭐ 16 | 🐛 6 | 🌐 Python | 📅 2026-08-16 - Python CLI that repairs Markdown links whose target moved (anchored by a UUID) and robustifies plain ones; report-only pre-commit/CI gate. GitHub Action & pre-commit hook included.
...
github: [`jekyll/jekyll` :octocat:](https://github.com/jekyll/jekyll) ⭐ 51,640 | 🐛 253 | 🌐 Ruby | 📅 2026-08-03,
...
github: [`middleman/middleman` :octocat:](https://github.com/middleman/middleman) ⭐ 7,112 | 🐛 18 | 🌐 Ruby | 📅 2026-08-16,
...
github: [`adam-p/markdown-here`](https://github.com/adam-p/markdown-here) ⭐ 60,251 | 🐛 318 | 🌐 JavaScript | 📅 2025-08-22) -
...
**Slidev** (github: [`slidev`](http://github.com/slidevjs/slidev) ⭐ 48,099 | 🐛 207 | 🌐 TypeScript | 📅 2026-08-14) - Slidev allows you to create slideshows from a markdown file. You can include HTML and Vue components in the markdown.

**Markpress** (github: [`markpress`](https://github.com/gamell/markpress) ⭐ 77 | 🐛 5 | 🌐 CSS | 📅 2022-11-19) - A command line tool and node package to convert markdown files into self-contained [impressjs](https://github.com/impress/impress.js/) ⭐ 38,193 | 🐛 59 | 🌐 JavaScript | 📅 2026-07-23 html presentations. [Example](https://gamell.github.io/markpress)
...
* [Resumx](https://resumx.dev) [:octocat:](https://github.com/resumx/resumx) ⭐ 167 | 🐛 6 | 🌐 TypeScript | 📅 2026-06-09 - Markdown resume renderer with auto page-fitting that outputs PDF, HTML, DOCX, and PNG
...
* [Jimmy :octocat:](https://github.com/marph91/jimmy) ⭐ 527 | 🐛 14 | 🌐 Python | 📅 2026-07-30 - Convert your notes to Markdown
...
* [turndown :octocat:](https://github.com/domchristie/turndown) ⭐ 11,388 | 🐛 149 | 🌐 HTML | 📅 2026-06-23, [(npm Package)](https://www.npmjs.com/package/turndown), [(Demo site)](http://domchristie.github.io/turndown/)  - a HTML to Markdown converter in JavaScript (formerly known as `to-markdown`)
...
* [jsdoc-to-markdown :octocat:](https://github.com/jsdoc2md/jsdoc-to-markdown) ⭐ 1,759 | 🐛 26 | 🌐 JavaScript | 📅 2025-10-03 - JavaScript API documentation via JSDoc to Markdown
...
* [GitBook.com](https://www.gitbook.com)  - write and publish books with Markdown and Git by Samy Pessé et al
  * [GitBook :octocat:](https://github.com/GitbookIO/gitbook) ⭐ 28,996 | 🐛 119 | 🌐 TypeScript | 📅 2026-08-15 - a command line tool (and Node.js library) for building beautiful books using GitHub/Git and Markdown (or AsciiDoc)
...
* [demarkus](https://github.com/latebit-io/demarkus) ⭐ 15 | 🐛 6 | 🌐 Go | 📅 2026-08-16 - De-centralized markup for us: a markdown protocol, server, browser, and tools
