Awesome Markdown Series - For Editors & (Pre)viewers, see [Awesome Markdown Editors & (Pre)viewers »](https://github.com/mundimark/awesome-markdown-editors) ⭐ 2,223 | 🐛 49 | 📅 2026-08-06
...
* [Markdown Cheatsheet :octocat:](https://github.com/adam-p/markdown-here/wiki/Markdown-Cheatsheet) ⭐ 60,250 | 🐛 318 | 🌐 JavaScript | 📅 2025-08-22
...
github: [github.com/jgm/pandoc](https://github.com/jgm/pandoc) ⭐ 45,872 | 🐛 1,048 | 🌐 Haskell | 📅 2026-08-14) -
...
**marked**
(web: [`marked.js.org`](https://marked.js.org), github: [marked :octocat:](https://github.com/markedjs/marked) ⭐ 37,054 | 🐛 15 | 🌐 JavaScript | 📅 2026-08-11) a markdown parser and compiler. Built for speed. (In Javascript)

<a name="markdown-it"></a>

**markdown-it**
(web: [`markdown-it.github.io`](https://markdown-it.github.io/), github: [markdown-it :octocat:](https://github.com/markdown-it/markdown-it) ⭐ 21,814 | 🐛 11 | 🌐 TypeScript | 📅 2026-08-13) Javascript markdown parser. 100% CommonMark support, extensions, syntax plugins & high speed.
...
**mq**
(web: [mqlang.org](https://mqlang.org), github: [mq :octocat:](https://github.com/harehare/mq) ⭐ 1,007 | 🐛 13 | 🌐 Rust | 📅 2026-08-15) A command-line tool that processes Markdown using a syntax similar to jq. Written in Rust, allowing you to easily slice, filter, map, and transform structured data in Markdown files.
...
* [vscode-markdownlint](https://github.com/DavidAnson/vscode-markdownlint) ⭐ 1,276 | 🐛 9 | 🌐 JavaScript | 📅 2026-08-14 - [Visual Studio Code Plugin](https://marketplace.visualstudio.com/items?itemName=DavidAnson.vscode-markdownlint) enabling in-place linting of markdown files.
...
* [darnlink](https://github.com/txemi/darnlink) ⭐ 16 | 🐛 5 | 🌐 Python | 📅 2026-08-15 - Python CLI that repairs Markdown links whose target moved (anchored by a UUID) and robustifies plain ones; report-only pre-commit/CI gate. GitHub Action & pre-commit hook included.
...
github: [`adam-p/markdown-here`](https://github.com/adam-p/markdown-here) ⭐ 60,250 | 🐛 318 | 🌐 JavaScript | 📅 2025-08-22) -
...
**Slidev** (github: [`slidev`](http://github.com/slidevjs/slidev) ⭐ 48,092 | 🐛 207 | 🌐 TypeScript | 📅 2026-08-14) - Slidev allows you to create slideshows from a markdown file. You can include HTML and Vue components in the markdown.

**Markpress** (github: [`markpress`](https://github.com/gamell/markpress) ⭐ 77 | 🐛 5 | 🌐 CSS | 📅 2022-11-19) - A command line tool and node package to convert markdown files into self-contained [impressjs](https://github.com/impress/impress.js/) ⭐ 38,192 | 🐛 59 | 🌐 JavaScript | 📅 2026-07-23 html presentations. [Example](https://gamell.github.io/markpress)
...
**GitPitch** (website: [GitPitch](http://gitpitch.com/), github: [gitpitch :octocat:](https://github.com/gitpitch/gitpitch/) ⭐ 5,477 | 🐛 13 | 🌐 Python | 📅 2021-03-01) – Markdown Presentations For Everyone on GitHub, GitLab, Bitbucket, GitBucket, Gitea, and Gogs. [Example](https://gitpitch.com/gitpitch/gitpitch/master)
...
* [Jimmy :octocat:](https://github.com/marph91/jimmy) ⭐ 526 | 🐛 14 | 🌐 Python | 📅 2026-07-30 - Convert your notes to Markdown
...
* [turndown :octocat:](https://github.com/domchristie/turndown) ⭐ 11,387 | 🐛 149 | 🌐 HTML | 📅 2026-06-23, [(npm Package)](https://www.npmjs.com/package/turndown), [(Demo site)](http://domchristie.github.io/turndown/)  - a HTML to Markdown converter in JavaScript (formerly known as `to-markdown`)
...
* [GitBook.com](https://www.gitbook.com)  - write and publish books with Markdown and Git by Samy Pessé et al
  * [GitBook :octocat:](https://github.com/GitbookIO/gitbook) ⭐ 28,997 | 🐛 120 | 🌐 TypeScript | 📅 2026-08-14 - a command line tool (and Node.js library) for building beautiful books using GitHub/Git and Markdown (or AsciiDoc)
...
* [demarkus](https://github.com/latebit-io/demarkus) ⭐ 15 | 🐛 5 | 🌐 Go | 📅 2026-08-14 - De-centralized markup for us: a markdown protocol, server, browser, and tools
